...
export async function GET(request:Request) {
    ...
    try {
        ...
        if (!result.success) {
            // this would display errors related to username only and 
            // if they aren't available then all other errors are shown indicated by []
            // this is carried out using zod
